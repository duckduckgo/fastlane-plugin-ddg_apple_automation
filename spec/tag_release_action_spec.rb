...
describe Fastlane::Actions::TagReleaseAction do
  ...
  describe "#create_tag_and_github_release" do
    ...
    platform_contexts = [
      { name: "on ios", repo_name: "duckduckgo/apple-monorepo-test" }, # KS TODO: Update to apple-browsers
      { name: "on macos", repo_name: "duckduckgo/apple-monorepo-test" } # KS TODO: Update to apple-browsers
    ]
